...
set "carpeta_backup=Backup!hora_actual!\"
    if not exist "!ruta_inicial!\!carpeta_backup!" (
        mkdir "!ruta_inicial!\!carpeta_backup!"
        )
...
echo.
copy /y "%archivo_cfg%" "%ruta_inicial%\!carpeta_backup!\conf_apps.cfg" >nul
...
move /y "Dianostico_Reparables-conf_apps.cfg.txt" "%ruta_inicial%\!carpeta_backup!\Dianostico_Reparables-conf_apps.cfg.txt" >nul
...
move /y "Dianostico_Irreparables-conf_apps.cfg.txt" "%ruta_inicial%\!carpeta_backup!\Dianostico_Irreparables-conf_apps.cfg.txt" >nul
...
echo %ruta_inicial%\!carpeta_backup!
...
echo En caso de que funcione mal se guardara un Backup en la carpeta !carpeta_backup!\Cheats.TXT
echo.
    ...
    for /d %%D in ("%ruta%\POPS\*") do (
        if exist "%%D.VCD" (
            ...
            if exist "!carpeta!\CHEATS.TXT" (
                set "carpeta_backupCH=Backup!hora_actual!\Cheats.TXT\"
                if not exist "!ruta_inicial!\!carpeta_backupCH!" (
                    mkdir "!ruta_inicial!\!carpeta_backupCH!"
                )
                if not exist "!ruta_inicial!\!carpeta_backupCH!\!solo_nombre!" (
                        mkdir "!ruta_inicial!\!carpeta_backupCH!\!solo_nombre!"
                        copy /y "%%D\CHEATS.TXT" "!ruta_inicial!\!carpeta_backupCH!\!solo_nombre!\CHEATS.TXT" >nul
                        )
