...
echo The latest OPL beta is having trouble running POPS
echo or at least the last time I tried
echo I tried installing the stable version 1.10 to test the games
echo.
...
)) > Diagnose_Repairables-app_configs.cfg.txt
...
))> Diagnose_Unrepairables-app_configs.cfg.txt
